...
type VoiceProvider = 'elevenlabs' | 'rime' | 'openai' | 'cartesia' | 'playht' | 'neets' | 'deepgram' | 'dubverse';
interface Tool {
    name: string;
    description: string;
    webhook: string;
...
interface ClientEvents {
    ...
    'ai_action': (action: any) => void;
    [key: string]: any;
}
interface ClientInterface {
    start(payload: IStartPayload | AgentConfig | string, metadata?: object, includeMetadataInPrompt?: boolean): Promise<void>;
    stop(): Promise<void>;
    mute(): void;
    unmute(): void;
}
...
export { type AgentConfig, AgentState, type ClientEvents, type ClientInterface, type Config, type Voice, type VoiceProvider, Millis as default };
